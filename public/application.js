...
var onSignInRequest = function onSignInRequest(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.signIn(data).then(ui.signInSuccess).then(getAllUserGames).catch(ui.signInFailure);
};
...
var onChangePass = function onChangePass(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.changePassword(data).then(ui.changePassSuccess).catch(ui.changePassFailure);
};
...
var onCreateGame = function onCreateGame(event) {
  ...
  var data = getFormFields(this);
  // debugger
  api.createGame(data).then(ui.createGameSuccess).then(getAllUserGames).catch(ui.apiFailure);
};
...
;var onGameChange = function onGameChange(event) {
  event.preventDefault();
  var data = getFormFields(this);
...
var onGameDelete = function onGameDelete(event) {
  ...
  api.destroyGame(gameId).then(ui.deleteGameSuccess).then(getAllUserGames).catch(ui.apiFailure);
};
// this event will close the update game form and show the add game option
var hideUpdateGame = function hideUpdateGame() {
  // console.log('event update game')
  ui.closeUpdateGame();
};
//
var showGameEdit = function showGameEdit() {
  ui.showGameEditForm();
};
...
var closeUpdateGame = function closeUpdateGame() {
...
var showGameEditForm = function showGameEditForm() {
  $('#gameCreateForm').hide();
  $('#gameUpdateForm').show();
  $('#updateCloseBtn').show();
};
module.exports = {
  ...
  closeUpdateGame: closeUpdateGame,
  toggleChangePassword: toggleChangePassword,
  showGameEditForm: showGameEditForm,
